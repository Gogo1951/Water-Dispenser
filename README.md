...
- ⚙️ **Tune It Per Scope** // Set how many stacks each class gets solo, in a party, or in a raid, and add any tradable consumable straight from your bags.
...
- 🦺 **Safety First** // Only ever moves the consumables you've set up — never your gear, quest items, or anything else in your bags.
...
6. *"Be the reason nobody ever types 'water plz' again."*
...
|---|---|---|
| Water | Mage | 1 / 2 / 4 stacks to mana users |
| Food | Mage | 1 / 2 / 4 stacks to everyone |
