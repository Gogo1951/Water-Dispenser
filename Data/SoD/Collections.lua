...
--[[
	Copied from Data/Era/Collections.lua and pruned by the same Classic Era client
	run, since Season of Discovery shares that client. Not yet run on a Season of
	Discovery realm.
]]
