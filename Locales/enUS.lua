...
L["CHAT_LOADED"] = "Version %s. Settings (including the option to disable this message) can be found under Options > AddOns > Water Dispenser. Enjoying Water Dispenser? Tell a friend! (="
...
L["CHAT_NONE_ACTIVE_FOR_CLASS"] = "No items are set to dispense while you're playing a %s. Open Options > Distribution Rules to enable items for this class."
...
L["BTN_CLEAR"] = "Clear Trade Window"
L["BTN_FILL"] = "Fill Trade Window"

--------------------------------------------------------------------------------
-- Minimap Button
--------------------------------------------------------------------------------

L["MINIMAP_DISPENSE"] = "Dispense"
L["MINIMAP_DISPENSE_DESC"] = "Automatically fills the trade window based on your settings."
L["UI_ENABLED"] = "Enabled"
L["UI_DISABLED"] = "Disabled"
L["UI_LEFT_CLICK"] = "Left-Click"
L["UI_TOGGLE"] = "Toggle"
L["MINIMAP_HINT"] = "Additional settings can be found under Options > AddOns > Water Dispenser."
...
L["OPTIONS_MINIMAP"] = "Enable Minimap Button"
L["OPTIONS_MINIMAP_DESC"] = "Show the Water Dispenser minimap button."
...
L["OPTIONS_COMMANDS"] = "/Commands"
L["OPTIONS_COMMANDS_WD"] = "Opens the Water Dispenser options panel."

L["OPTIONS_DISPENSE_HEADER"] = "Dispense"
L["OPTIONS_DISPENSE_DESC"] = "Auto-fill the trade window automatically when a trade opens. Each scope is toggled independently."
...
L["OPTIONS_DISPENSE_SOLO_DESC"] = "Fills the trade window automatically when trading with someone who is not in your party or raid."
L["OPTIONS_DISPENSE_GROUP"] = "Enable for Party Members"
L["OPTIONS_DISPENSE_GROUP_DESC"] = "Fills the trade window automatically when trading with a party member."
L["OPTIONS_DISPENSE_RAID"] = "Enable for Raid Members"
