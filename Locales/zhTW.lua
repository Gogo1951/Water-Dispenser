...
L["CHAT_LOADED"] = "版本 %s。設定（包含關閉此訊息的選項）可以在 選項 > 插件 > Water Dispenser 中找到。喜歡 Water Dispenser 嗎？分享給你的朋友吧！(="
L["CHAT_NO_TRADE"] = "沒有開啟的交易視窗。"
L["CHAT_COMBAT_PAUSED"] = "戰鬥中已暫停自動填充。"
L["CHAT_COMBAT_RESUMED"] = "戰鬥結束。恢復交易填充。"
L["CHAT_MISSING_STACK"] = "缺失的堆疊數："
L["CHAT_NONE_ACTIVE_FOR_CLASS"] = "當你使用 %s 遊玩時，沒有設定任何要分發的物品。請打開 選項 > 分發規則 啟用適用於此職業的物品。"
L["CHAT_ITEM_SAVED"] = "已儲存："
L["CHAT_ITEM_REMOVED"] = "已移除："
L["CHAT_RESET"] = "所有選項已重置為預設值。"
L["CHAT_MACRO_CREATED"] = "喊話巨集「- Dispenser」已準備就緒。打開巨集介面（遊戲選單 > 巨集，或輸入 /m），將其拖曳到快捷列上即可使用。"
...
L["MINIMAP_DISPENSE_DESC"] = "根據你的設定自動填充交易視窗。"
L["UI_ENABLED"] = "已啟用"
L["UI_DISABLED"] = "已停用"
L["UI_LEFT_CLICK"] = "左鍵點擊"
L["UI_TOGGLE"] = "切換"
L["MINIMAP_HINT"] = "更多設定可以在 選項 > 插件 > Water Dispenser 中找到。"
...
L["OPTIONS_DESC"] = "根據交易對象的職業、等級和隊伍狀態，自動用設定好的水、食物、治療石或其他消耗品來填充交易視窗。"
...
L["OPTIONS_CONJURE_BUTTONS"] = "為法師和術士啟用交易視窗製造按鈕"
L["OPTIONS_CONJURE_BUTTONS_DESC"] = "在交易視窗旁邊顯示智能等級匹配的造水、造食和製造治療石按鈕。"
L["OPTIONS_MISSING_STACK_WARNINGS"] = "顯示堆疊不足警告"
L["OPTIONS_MISSING_STACK_WARNINGS_DESC"] = "當背包中配置的物品不足以填滿交易視窗時，在聊天框中輸出提示。"

L["OPTIONS_COMMANDS"] = "/指令"
L["OPTIONS_COMMANDS_WD"] = "打開 Water Dispenser 選項介面。"

L["OPTIONS_DISPENSE_HEADER"] = "分發"
L["OPTIONS_DISPENSE_DESC"] = "在打開交易視窗時自動填充。每一種範圍皆可獨立切換。"
...
L["OPTIONS_COMBAT_DESC"] = "為了防止出現介面錯誤，進入戰鬥時自動填充功能將始終暫停，並在聊天框發送提醒。脫離戰鬥後，如果交易視窗依然處於開啟狀態，交易將自動恢復。"

L["OPTIONS_RESET_HEADER"] = "重置"
L["OPTIONS_RESET_DESC"] = "將目前角色的所有 Water Dispenser 設定恢復為預設值，包含你的自訂物品清單。"
...
L["OPTIONS_ITEMS_DESC"] = "配置要分發每種物品的堆疊數量。注意：經典版和 TBC 紀念版不支援自動拆分堆疊。抱歉！"
L["OPTIONS_ITEMS_EMPTY"] = "未配置物品。請打開「新增物品」分頁，從背包中加入消耗品。"

L["OPTIONS_ITEM_SETTINGS"] = "物品設定"
L["OPTIONS_ITEM_USE_NOT_FULL"] = "使用不完整的堆疊填充"
L["OPTIONS_ITEM_USE_NOT_FULL_DESC"] = "當無法湊齊完整堆疊時，使用背包裡現有的零散數量進行填充。"
...
L["OPTIONS_ITEM_KEEP_AT_LEAST_DESC"] = "包裡始終至少保留這些數量。只有超過此數量的部分才會被視為可贈送的物品。"
L["OPTIONS_ITEM_INCLUDE_QUANTITY"] = "在喊話巨集中包含剩餘數量"
L["OPTIONS_ITEM_INCLUDE_QUANTITY_DESC"] = "當巨集列出此物品時，包含你還剩下多少。如果你只想說你有該物品而不提數量（如治療石），請關閉此選項。"
L["OPTIONS_ITEM_PLAYER_CLASSES"] = "僅在遊玩指定職業時分發"
L["OPTIONS_ITEM_PLAYER_CLASSES_DESC"] = "僅當你的角色是以下所選職業時，才會填充該物品並將其加入喊話中。"
...
L["OPTIONS_ADD_DESC"] = "從背包中選擇一個可交易的消耗品加到配置中。已配置或已綁定的物品不會出現在此處。"
...
L["OPTIONS_ANNOUNCEMENTS_PREVIEW_EMPTY"] = "沒有可喊話的內容。配置物品，補充背包，或降低「最少保留數量」的值。"
