...
L["CHAT_LOADED"] = "Version %s. Les paramètres (y compris l'option pour désactiver ce message) se trouvent dans Options > AddOns > Water Dispenser. Vous aimez Water Dispenser ? Parlez-en à vos amis ! (="
...
L["CHAT_NONE_ACTIVE_FOR_CLASS"] = "Aucun objet n'est configuré pour être distribué pendant que vous jouez un %s. Ouvrez Options > Règles de distribution pour activer des objets pour cette classe."
...
L["CHAT_MACRO_CREATED"] = "La macro d'annonce \"- Dispenser\" est prête. Ouvrez l'interface des macros (Menu de jeu > Macros, ou /m) et glissez-la sur votre barre d'action."
...
L["MINIMAP_DISPENSE_DESC"] = "Remplit automatiquement la fenêtre d'échange selon vos paramètres."
L["UI_ENABLED"] = "Activé"
L["UI_DISABLED"] = "Désactivé"
L["UI_LEFT_CLICK"] = "Clic gauche"
L["UI_TOGGLE"] = "Basculer"
L["MINIMAP_HINT"] = "Des paramètres supplémentaires se trouvent dans Options > AddOns > Water Dispenser."
...
L["OPTIONS_CONJURE_BUTTONS"] = "Activer les boutons d'échange pour Mages & Démonistes"
L["OPTIONS_CONJURE_BUTTONS_DESC"] = "Affiche les boutons Invoquer de l'eau, Invoquer de la nourriture et Créer une Pierre de soins selon le niveau à côté de la fenêtre d'échange."
...
L["OPTIONS_DISPENSE_DESC"] = "Remplit la fenêtre d'échange automatiquement dès son ouverture. Chaque portée est gérée séparément."
...
L["OPTIONS_RESET_BUTTON"] = "Réinitialiser toutes les options de Water Dispenser"
...
L["OPTIONS_ITEMS_DESC"] = "Configurez combien de piles de chaque objet distribuer. Note : Classic Era et TBC Anniversary ne supportent pas la division automatique des piles. Désolé !"
