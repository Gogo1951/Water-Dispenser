...
L["CHAT_LOADED"] = "Versión %s. Los ajustes (incluyendo la opción de desactivar este mensaje) se encuentran en Opciones > Accesorios > Water Dispenser. ¿Te gusta Water Dispenser? ¡Cuéntaselo a un amigo! (="
...
L["CHAT_NONE_ACTIVE_FOR_CLASS"] = "No hay objetos configurados para dispensar mientras juegas con un %s. Abre Opciones > Reglas de distribución para habilitar objetos para esta clase."
L["CHAT_ITEM_SAVED"] = "Guardado:"
L["CHAT_ITEM_REMOVED"] = "Eliminado:"
L["CHAT_RESET"] = "Todas las opciones han sido restablecidas."
L["CHAT_MACRO_CREATED"] = "Macro de anuncio \"- Dispenser\" lista. Abre la IU de Macros (Menú de juego > Macros, o /m) y arrástrala a tu barra de acción."
...
L["BTN_CLEAR"] = "Limpiar ventana de comercio"
L["BTN_FILL"] = "Llenar ventana de comercio"
...
L["MINIMAP_DISPENSE_DESC"] = "Llena automáticamente la ventana de comercio según tus ajustes."
L["UI_ENABLED"] = "Activado"
L["UI_DISABLED"] = "Desactivado"
L["UI_LEFT_CLICK"] = "Clic izquierdo"
L["UI_TOGGLE"] = "Alternar"
L["MINIMAP_HINT"] = "Los ajustes adicionales se encuentran en Opciones > Accesorios > Water Dispenser."
...
L["OPTIONS_CONJURE_BUTTONS"] = "Activar botones de conjurar para Magos y Brujos"
L["OPTIONS_CONJURE_BUTTONS_DESC"] = "Muestra botones de conjurar agua, comida y piedras de salud (según tu nivel) junto a la ventana de comercio."
...
L["OPTIONS_DISPENSE_DESC"] = "Llena la ventana de comercio automáticamente al abrirse. Cada ámbito se alterna de forma independiente."
...
L["OPTIONS_DISPENSE_SOLO_DESC"] = "Llena la ventana de comercio automáticamente al comerciar con alguien que no está en tu grupo o banda."
L["OPTIONS_DISPENSE_GROUP"] = "Llenar para miembros del grupo"
L["OPTIONS_DISPENSE_GROUP_DESC"] = "Llena la ventana de comercio automáticamente al comerciar con un miembro del grupo."
L["OPTIONS_DISPENSE_RAID"] = "Llenar para miembros de banda"
L["OPTIONS_DISPENSE_RAID_DESC"] = "Llena la ventana de comercio automáticamente al comerciar con un miembro de la banda."
...
L["OPTIONS_RESET_BUTTON"] = "Restablecer todas las opciones de Water Dispenser"
...
L["OPTIONS_ITEMS_DESC"] = "Configura cuántos montones de cada objeto dispensar. Nota: Classic Era y TBC Anniversary no soportan la división automatizada de montones. ¡Lo sentimos!"
...
L["OPTIONS_ITEM_INCLUDE_QUANTITY_DESC"] = "Incluye la cantidad restante al anunciar este objeto. Desactívalo si prefieres solo decir que lo tienes sin el recuento (típico para piedras de salud)."
